...
- ถ้ารายละเอียดสินค้า/รายการ ไม่ชัดเจน → ใช้ "N/A" (อย่าเดา!)
...
- นโยบาย N/A สำหรับข้อมูลที่หายไป
- ตรวจสอบบัญชีคู่`
...
4. **เจ้าหนี้**: ต้องเลือกจากรายการเจ้าหนี้ที่กำหนดให้ หรือใช้ "N/A" ถ้าไม่เกี่ยวข้องจริง
