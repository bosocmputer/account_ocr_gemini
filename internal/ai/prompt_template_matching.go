...
2️⃣ ใบเสร็จรับเงิน/ใบกำกับภาษี (Receipt/Tax Invoice)
   ...
   🎯 กฎการจับคู่แบบ Smart:
   
   A) วิเคราะห์เอกสารก่อน:
      - ระบุ "ผู้ออกเอกสาร" (ชื่อบริษัท/ร้านที่อยู่หัวเอกสาร)
      - ระบุ "ลูกค้า/ผู้รับบริการ" (มักมีคำว่า "ชื่อลูกค้า", "NAME")
      - ระบุ "ประเภทสินค้า/บริการ" (อะไรที่ซื้อขาย)
      - ระบุ "ทิศทาง": เราเป็นผู้ขาย หรือ เราเป็นผู้ซื้อ?
   
   B) วิเคราะห์ Template Description:
   ...
   C) เปรียบเทียบและตัดสินใจ:
      
      ✅ ตรงกับ template เมื่อ:
         - เอกสารและ template เป็นประเภทเดียวกัน (เช่น ทั้งคู่เป็นใบเสร็จรับเงิน)
         - ถ้า template ระบุชื่อบริษัท → บริษัทนั้นต้องเป็นผู้ออกเอกสารจริงๆ
         - ถ้า template ระบุประเภทสินค้า → สินค้าในเอกสารต้องตรงกับที่ระบุ
         - ทิศทางธุรกรรมต้องสอดคล้องกัน (ขาย vs ซื้อ)
      
      ❌ ไม่ตรง template เมื่อ:
         - บริษัทที่ระบุใน template ไม่ใช่ผู้ออกเอกสาร (อาจเป็นลูกค้าแทน)
         - ประเภทสินค้า/บริการไม่ตรงกัน
         - ทิศทางธุรกรรมตรงข้าม
      
      💡 เคล็ดลับการวิเคราะห์:
         - ดูจาก "สมุดรายวัน" ใน description (ถ้ามี):
           * "สมุดรายวันรับ" (IV) = เรารับเงิน = เราเป็นผู้ขาย
           * "สมุดรายวันจ่าย" (PV) = เราจ่ายเงิน = เราเป็นผู้ซื้อ
         - ดูจากบัญชีที่ใช้ (ถ้ามี):
           * "ลูกหนี้การค้า" = เราเป็นผู้ขาย
           * "เจ้าหนี้การค้า" = เราเป็นผู้ซื้อ
   
   D) หลักการสำคัญ:
      ✅ เน้นความสอดคล้องของบริบทธุรกรรม
      ✅ ตรวจสอบบทบาทของแต่ละฝ่าย (ผู้ออก vs ลูกค้า)
      ✅ ดูประเภทสินค้า/บริการเป็นหลัก
